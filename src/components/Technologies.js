...
function Technologies() {
    ...
    const handleEditBtn = async (technology) => {
        ...
        try {
            ...
            setValue("technology_id", technology.technology_id);
            setValue("technology_name", technology.technology_name);
            setValue("status", technology.status?.toLowerCase() === 'inactive' ? '0' : '1');
    
            console.log("Updated form values with:", {
                technology_id: technology.technology_id,
                technology_name: technology.technology_name,
                status: technology.status?.toLowerCase() === 'inactive' ? '0' : '1'
            });
        ...
        <div className="table-container" style={{ overflowX: 'hidden', overflowY: 'hidden', width: '100%', padding: '70px' }}>
            ...
            <Modal show={modalBox} onHide={() => setModalBox(false)}>
                <Modal.Header closeButton>
                    <Modal.Title>Confirm Inactivate</Modal.Title>
                </Modal.Header>
                <Modal.Body>Are you sure you want to inactivate this technology?</Modal.Body>
                <Modal.Footer>
                    <Button variant="secondary" onClick={() => setModalBox(false)}>
                        Cancel
                    </Button>
            ...
            <div className="p-6 bg-white rounded-lg shadow" style={{ padding: '20px' }}>
                ...
                <div className="offcanvas offcanvas-end customeoff addtask" tabIndex="-1" id="offcanvasExample1">
                    ...
                    <div className="offcanvas-body">
                        <div className="container-fluid">
                            <form onSubmit={handleSubmit(onSubmit)} id="technology-form" className="row g-3 needs-validation">
                                <div className="col-md-12">
                                    <label htmlFor="technology_name" className="form-label">Technology Name <span className="text-danger">*</span></label>
                                    <Controller
                                        name="technology_name"
                                        control={control}
                                        rules={{ required: "Technology name cannot be empty" }}
                                        render={({ field }) => (
                                            <input
                                                type="text"
                                                className={`form-control ${errors.technology_name ? 'is-invalid' : ''}`}
                                                id="technology_name"
                                                placeholder="Technology Name"
                                                {...field}
                                            />
                                    ...
                                    />
                                    {errors.technology_name && <span className="text-danger">{errors.technology_name.message}</span>}
                                </div>
                                <div className="col-md-12">
                                    <div className="custom__form__inputs">
                                        <label htmlFor="status" className="form-label">Status <span className="text-danger">*</span></label>
